...
class MonthBudgetAPIController extends ApiBaseController
{
  ...
  /**
     * Display base Month Budgets (where user_id = null)
     *
     * @return JsonResponse
     */
    public function baseMonthBudgets(): JsonResponse
    {
        $result = MonthBudget::withoutGlobalScope(AuthUserScope::class)->whereNull('user_id')->get();
        return $this->sendSuccess($result->toArray(), 'Base month budgets retrieved successfully');    
    }
}
